...
Esse projeto contém uma série de funções usadas para treinar os conceitos de `High Order Funcions` (HOF'S) e `ES6`. É considerado um dos mais desafiadores da trilha na Trybe. 
---
